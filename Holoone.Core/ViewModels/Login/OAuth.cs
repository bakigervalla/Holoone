...
namespace HolooneNavis.ViewModels.Login
{
    ...
    public sealed class OAuthRequest
    {
        ...
        private const string AuthorizationEndpoint = "https://core.naea1.holo-one.lenovo.com"; //"https://accounts.google.com/o/oauth2/v2/auth";
        private const string TokenEndpoint = "https://core.naea1.holo-one.lenovo.com"; //"https://www.googleapis.com/oauth2/v4/token";
        private const string UserInfoEndpoint = "https://core.naea1.holo-one.lenovo.com"; //"https://www.googleapis.com/oauth2/v3/userinfo";
